    ...
    <section className={styles["staff-card"]}>
      <div className={styles["staff-info"]}>
        <div className={styles["staff-details"]}>
          <div className={styles["staff-name"]}>{firstName}        {lastName}</div>
    ...
    <>
      <section className={styles["main-container"]}>
        ...
        <section className={styles["content"]}>
          ...
          {filteredStaff.length > 0 ? (filteredStaff.map((staffMember, index) => (
